...
class ResConfigSettings(models.TransientModel):
    ...
    auth_signup_with_birthday = fields.Boolean(string='Date of Birth', default=True)
    ...
    def get_values(self):
        ...
        res.update(
            ...
            auth_signup_with_birthday=get_param('auth_signup_with_birthday', 'False').lower() == 'true',
    ...
    def set_values(self):
        ...
        set_param('auth_signup_with_birthday', repr(self.auth_signup_with_birthday))
